    ...
    public static void main(String[] args) throws Exception {
                        ...
                        <body>
                            ...
                            <div class="container">
                                ...
                                <div class="card">
                                    <h3>Ver Animais</h3>
                                    <p>Consultar lista completa</p>
                                    <a href="/animais">Abrir</a>
                                </div>

                                <div class="card">
                                    <h3>+ Novo Animal</h3>
                                    <p>Adicionar novo registo</p>
                                    <a href="/novoanimal">Criar</a>
                                </div>
        ...
        server.createContext("/animais", exchange -> {
            ...
            html.append("""
                        ...
                        <a href='/novoanimal'>+ Novo Animais</a><br><br>
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    html.append("<td>");
                    html.append("<a href='/editaranimal?id=").append(id).append("'>Editar</a>");
                    html.append("<a href='/apagaranimal?id=").append(id)
        ...
        // FORM NOVO ANIMAL
        server.createContext("/novoanimal", exchange -> {
            ...
            html.append("""
                        ...
                        <form method='POST' action='/guardaranimal'>
                            NumeroCA:
                            ...
                            Data de Nascimento:
                            <input name='dataNascimento' type='dataNascimento' required>
        ...
        // GUARDAR NOVO ANIMAL
        server.createContext("/guardaranimal", exchange -> {
            ...
            try {
                ...
                html.append("""
                            ...
                            <a href='/novoanimal'>Inserir novo animal</a>
        ...
        // FORM EDITAR ANIMAL
        server.createContext("/editaranimal", exchange -> {
            ...
            try {
                ...
                html.append("""
                            ...
                            <form method='POST' action='/atualizaranimal'>
                        """);

                html.append("<input type='hidden' name='id' value='").append(id).append("'>");

                html.append("NumeroCA:<input name='numeroCA' value='").append(numeroCA).append("' required>");
                html.append("Nome:<input name='nomeAnimal' value='").append(nomeAnimal).append("' required>");
                html.append("Data de nascimento:<input name='dataNascimento' value='").append(dataNascimento).append("'>");
        ...
        // ATUALIZAR ANIMAL
        server.createContext("/atualizaranimal", exchange -> {
        ...
        // ELIMINAR ANIMAL
        server.createContext("/apagaranimal", exchange -> {
